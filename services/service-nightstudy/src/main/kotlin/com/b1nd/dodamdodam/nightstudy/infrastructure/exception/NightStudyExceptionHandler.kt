package com.b1nd.dodamdodam.nightstudy.infrastructure.exception
...
class NightStudyExceptionHandler: GlobalExceptionHandler {

    private val log = LoggerFactory.getLogger(NightStudyExceptionHandler::class.java)
